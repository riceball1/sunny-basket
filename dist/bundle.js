(() => {
  ...
  function doesNotTargetIFrame(name) {
    if (name === "_blank") {
      ...
      for (const element2 of document.getElementsByName(name)) {
  ...
  var LinkInterceptor = class {
    ...
    clickEventIsSignificant(event) {
      ...
      const element2 = findLinkFromClickTarget(target) || target;
      return element2 instanceof Element && element2.closest("turbo-frame, html") == this.element;
    }
  };
  ...
  var Idiomorph = /* @__PURE__ */ function() {
    ...
    function ignoreAttribute(attr2, to, updateType, ctx) {
      if (attr2 === "value" && ctx.ignoreActiveValue && to === document.activeElement) {
        return true;
      }
      return ctx.callbacks.beforeAttributeUpdated(attr2, to, updateType) === false;
    }
  ...
  var MorphingPageRenderer = class extends PageRenderer {
    static renderElement(currentElement, newElement) {
      morphElements(currentElement, newElement, {
        callbacks: {
          beforeNodeMorphed: (element2) => !canRefreshFrame(element2)
        }
      });
...
%o`, message, error2, detail);
  ...
  function create_fragment(ctx) {
    ...
    return {
      c() {
        ...
        attr(h1, "class", "italic text-blue-700");
        attr(div, "class", "container max-width");
      },
      m(target, anchor) {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props2) => {
      if ("target" in $$props2) $$invalidate(0, target = $$props2.target);
    };
    return [target];
  }
